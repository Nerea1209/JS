...
function Selector(props) {
  return (
    <div style={{flex: "100%", display:"Flex", alignItems:"center", marginBottom:"4rem", justifyContent:"space-around"}}>
      ...
      <Button style={{width:"2rem", height:"2rem", lineHeight:"1rem"}} color='success' outline>-</Button>
      <span>10</span>
      <Button style={{width:"2rem", height:"2rem", lineHeight:"1rem", padding:0}} color='danger' outline>+</Button>
